...
app.use('/appointments', routes_1.default);
...
const server = app.listen(config_1.config.port, () => {
    logger.info(`Appointment service running on port ${config_1.config.port}`, {
...
const gracefulShutdown = async () => {
    ...
    await eventPublisher_1.eventPublisher.disconnect();
